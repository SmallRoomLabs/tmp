...
check: pdp8emu coremakebin coremakerim
	...
	./pdp8emu CORE-D0JB 2>CORE-D0JB.2.tmp | tee CORE-D0JB.1.tmp &
		...
		grep -ao '1' CORE-D0AB.1.tmp | wc -l
		grep -ao '2' CORE-D0BB.1.tmp | wc -l
		grep -ao 'RANDOM' CORE-D0CC.1.tmp | wc -l
		grep -ao 'A' CORE-D0DB.1.tmp | wc -l
		grep -ao 'T' CORE-D0EB.1.tmp | wc -l
		grep -ao 'FC' CORE-D0FC.1.tmp | wc -l
		grep -ao 'G' CORE-D0GC.1.tmp | wc -l
		grep -ao 'HC' CORE-D0HC.1.tmp | wc -l
		grep -ao 'I' CORE-D0IB.1.tmp | wc -l
		grep -ao 'JB' CORE-D0JB.1.tmp | wc -l
